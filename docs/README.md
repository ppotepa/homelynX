# Homelynx documentation

- [ARCHITECTURE.md](ARCHITECTURE.md) — runtime boundaries and project responsibilities.
- [ENGINE.md](ENGINE.md) — invocation, capability execution, ACL, confirmation and state.
